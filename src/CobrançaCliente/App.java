...
public class App {
    public static void main(String[] args) {
        ...
        Cliente cliente1 = new Cliente("João", "+557196721541", LocalDate.now()); // Pendente hoje
        Cliente cliente2 = new Cliente("Maria", "+557196721542", LocalDate.now().plusDays(2)); // Vence em 2 dias
